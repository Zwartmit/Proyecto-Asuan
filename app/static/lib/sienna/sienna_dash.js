document.addEventListener("DOMContentLoaded", function () {
    ...
    let o = n([
        { label: "Saturación baja", key: "low-saturation", icon: "gradient" },
        { label: "Saturación alta", key: "high-saturation", icon: "filter_vintage" },
        { label: "Contraste alto", key: "high-contrast", icon: "tonality" }
    ], "asw-filter"),
        l = n([
        ], "asw-tools");
    ...
    <div class="asw-widget">
        ...
        <div class="asw-menu">
            ...
            <div class="asw-menu-content">
                ...
                <div class="asw-card" style="margin-top: 15px;">
                    <div class="asw-card-title">Ajustes generales</div>
    ...
    const h = function (e, s) {
        let a = !1;
        !s && e && (a = e.currentTarget, s = parseFloat(t.states.fontSize) || 1, a.classList.contains("asw-minus") ? s -= .1 : s += .1, s = Math.max(s, 0.8), s = Math.min(s, 1.2), s = parseFloat(s.toFixed(2))), document.querySelectorAll("h1,h2,h3,h4,h5,h6,dl,dt,li,ol,th,td").forEach((function (t) {
