...
from app.views.ventacaja.views import *
...
urlpatterns = [
    ...
    ### CRUD VENTA_CAJA ###
    path('ventacaja/listar/', VentaCajaListView.as_view(), name='ventacaja_lista'),
    path('ventacaja/crear/', VentaCajaCreateView.as_view(), name='ventacaja_crear'),
    path('ventacaja/editar/<int:pk>/', VentaCajaUpdateView.as_view(), name='ventacaja_editar'),
    path('ventacaja/eliminar/<int:pk>/', VentaCajaDeleteView.as_view(), name='ventacaja_eliminar'),
